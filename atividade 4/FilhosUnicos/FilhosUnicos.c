...
int filhosUnicos(struct No *, int);
...
int filhosUnicos(struct No *r, int numFilhosUnicos) {

    if(r->esquerda != NULL || r->direita != NULL) {
        if(r->esquerda == NULL) {
            numFilhosUnicos++;
            numFilhosUnicos = filhosUnicos(r->direita, numFilhosUnicos);
        }
        else if(r->direita == NULL) {
            numFilhosUnicos++;
            numFilhosUnicos = filhosUnicos(r->esquerda, numFilhosUnicos);
        }
        else {
            numFilhosUnicos = filhosUnicos(r->esquerda, numFilhosUnicos);
            numFilhosUnicos = filhosUnicos(r->direita, numFilhosUnicos);
