...
int contaFolhas(struct No *r, int numFolhas) {
    ...
    if(r->esquerda == NULL && r->direita == NULL) {
        ...
        if(r->esquerda != NULL) {
            numFolhas = contaFolhas(r->esquerda, numFolhas);
        }

        if(r->direita != NULL) {
            numFolhas = contaFolhas(r->direita, numFolhas);
        }
    }
